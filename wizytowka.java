...
public class wizytowka {			//G³ówna klasa
	...
	public static void menu() {
		...
		System.out.println("7. Zamknij program");			//Wyœwietlanie treœci menu
		System.out.println("-----------------------");			//Wyœwietlanie treœci menu
	}
			...
			if(kontrolka==1) {			//Sprawdzanie czy warunek jest poprawny i w razie prawdy wykonuje czynnoœci
				...
				odczyt_wizytowek();			//odwo³anie siê do funkcji odczyt_wizytowek
					...
					for(int liczba = 0; liczba <= 99;liczba++) {			//Pêtla która ma dzia³aæ dopóki warunek wskazuje prawdê oraz po warunku jest podana inkrementacja
						...
						if(obiekt[liczba].imie=="Amelia") {
							zlicz_imiona[0]+=1;
						}else if(obiekt[liczba].imie=="Wiktor") {
							zlicz_imiona[1]+=1;
						}else if(obiekt[liczba].imie=="Adam") {
							zlicz_imiona[2]+=1;
						}
					}
				...
				if(zlicz_imiona[0]==0 && zlicz_imiona[1]==0 && zlicz_imiona[2]==0) {
					System.out.println("¯adne z wybranych imion siê nie pojawia");
				}else{
					System.out.println("Amelia pojawia siê : " + zlicz_imiona[0]);
					System.out.println("Wiktor pojawia siê : " + zlicz_imiona[1]);
					System.out.println("Adam pojawia siê : " + zlicz_imiona[2]);
				}
			}
		}while(kontrolka<7);			//warunek pêtli do (dzia³a je¿eli kontrolka jest mniejsza ni¿ 5)
